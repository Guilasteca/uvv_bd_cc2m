...
\c uvv Guilasteca;
123456 
You are now connected to database "uvv" as user "Guilasteca".

create schema elmasri authorization thierry;


alter user Guilasteca set search_path to elmasri, "\$user', public;
...
COMMENT ON TABLE elmasri.funcionario IS 'Informações dos funcionários.';
